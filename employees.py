...
class Employee(ABC):
    ...
    def performance(self, value):
        self._performance = min(max(PERCENTAGE_MIN, value), PERCENTAGE_MAX)
    ...
    def happiness(self, value):
        self._happiness = min(max(PERCENTAGE_MIN, value), PERCENTAGE_MAX)
...
class TemporaryEmployee(Employee):
    ...
    def interact(self, other):
        ...
        if other == self._Employee__manager:
